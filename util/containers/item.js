...
module.exports = {
    ...
    'rock': createItem('Rock', 2, 1, 0, 16, 'rock', 'Items', 'Common', 0, true, true),
    'bone': createItem('Bone', 12, 7, 0, 17, 'bone', 'Items', 'Common', 0, true, true),
    'shell': createItem('Shell', 5, 2, 0, 18, 'shell', 'Items', 'Common', 0, true, true),
